...
export default function Rental() {
  ...
  useEffect(() => {
    listingService.getListingById(id).then(setListing).catch(() => setListing(null));
  }, [id]);
  ...
  if (isSubmitted) {
    return (
      <main className="rental-page">
        <h1>Request sent!</h1>
        <p>Your rental request has been submitted. You can track it from your account.</p>
